...
type GetDeliveryStatusResponse struct {
	state           protoimpl.MessageState `protogen:"open.v1"`
	DeliveryId      string                 `protobuf:"bytes,1,opt,name=delivery_id,json=deliveryId,proto3" json:"delivery_id,omitempty"`
	Status          DeliveryStatus         `protobuf:"varint,2,opt,name=status,proto3,enum=proto.v1.DeliveryStatus" json:"status,omitempty"` // "created", "in_progress", "completed", "canceled"
...
const file_proto_delivery_proto_rawDesc = "" +
	"\n" +
	"\x14proto/delivery.proto\x12\bproto.v1\"\xa5\x01\n" +
	...
	"\vdelivery_id\x18\x01 \x01(\tR\n" +
	"deliveryId\x120\n" +
	"\x06status\x18\x02 \x01(\x0e2\x18.proto.v1.DeliveryStatusR\x06status\x12\x19\n" +
	...
	"\rStartDelivery\x12\x1e.proto.v1.StartDeliveryRequest\x1a\x1f.proto.v1.StartDeliveryResponse\x12\\\n" +
	"\x11GetDeliveryStatus\x12\".proto.v1.GetDeliveryStatusRequest\x1a#.proto.v1.GetDeliveryStatusResponse\x12S\n" +
	"\x0eCancelDelivery\x12\x1f.proto.v1.CancelDeliveryRequest\x1a .proto.v1.CancelDeliveryResponseBQZOgithub.com/odlev/animal-delivery/contracts/gen/go/animaldelivery;animaldeliveryb\x06proto3"
...
var file_proto_delivery_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_proto_delivery_proto_goTypes = []any{
	(DeliveryStatus)(0),               // 0: proto.v1.DeliveryStatus
	(*StartDeliveryRequest)(nil),      // 1: proto.v1.StartDeliveryRequest
	(*StartDeliveryResponse)(nil),     // 2: proto.v1.StartDeliveryResponse
	(*GetDeliveryStatusRequest)(nil),  // 3: proto.v1.GetDeliveryStatusRequest
	(*GetDeliveryStatusResponse)(nil), // 4: proto.v1.GetDeliveryStatusResponse
	(*CancelDeliveryRequest)(nil),     // 5: proto.v1.CancelDeliveryRequest
	(*CancelDeliveryResponse)(nil),    // 6: proto.v1.CancelDeliveryResponse
}
var file_proto_delivery_proto_depIdxs = []int32{
	0, // 0: proto.v1.GetDeliveryStatusResponse.status:type_name -> proto.v1.DeliveryStatus
	1, // 1: proto.v1.DeliveryService.StartDelivery:input_type -> proto.v1.StartDeliveryRequest
	3, // 2: proto.v1.DeliveryService.GetDeliveryStatus:input_type -> proto.v1.GetDeliveryStatusRequest
	5, // 3: proto.v1.DeliveryService.CancelDelivery:input_type -> proto.v1.CancelDeliveryRequest
	2, // 4: proto.v1.DeliveryService.StartDelivery:output_type -> proto.v1.StartDeliveryResponse
	4, // 5: proto.v1.DeliveryService.GetDeliveryStatus:output_type -> proto.v1.GetDeliveryStatusResponse
	6, // 6: proto.v1.DeliveryService.CancelDelivery:output_type -> proto.v1.CancelDeliveryResponse
